...
## **Logo Description**
### The logo for *Valorant: Beyond the Crosshair* is uploaded in the same repository this README file is in.
...
## **Wireframes / Mock-ups**
### Attached in our repository are the proposed layouts/mock-ups of each page.
### All web pages will also include a fixed, responsive top navigation bar with links to our subpages like *The Agents, The Maps, The Weapons, etc.*
### It also includes a hover feature for links so that it looks better.
### Along with this, the top navigation bar will contain the links to all the different web pages that aren't the one you're currently on.
